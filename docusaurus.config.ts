...
const config: Config = {
  ...
  organizationName: 'jimzord12', // Usually your GitHub org/user name.
  projectName: 'edu-games-front', // Usually your repo name.
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        {
          type: 'docSidebar',
          sidebarId: 'physicsSidebar', // check sidebars.ts
          position: 'left',
          label: 'Physics',
        },
